...
Call `mcp__team-sdd__sdd_get_context` before `mcp__team-sdd__sdd_status` for `$1`. Treat both tool responses as internal structured data. Do not show raw MCP JSON, envelopes, or a separate Core-result summary.
